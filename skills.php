...
<div class="container">
    ...
    <div class="row text-center">
        <div class="col-sm-12">
            <button type="button" onClick="badgeClick(this.value)" class="btn btn-dark" value="SAP Business Objects">SAP Business Objects <span class="badge badge-light">8</span></button>
    ...
    <div class="row text-center">
        <div class="col-sm-12">                                          
            ...
            <button type="button" onClick="badgeClick(this.value)" class="btn btn-dark" value="GeneXus">GeneXus <span class="badge badge-light">7</span></button>
            ...
            <button type="button" onClick="badgeClick(this.value)" class="btn btn-dark" value="Power BI">Power BI <span class="badge badge-light">6</span></button>                    
            <button type="button" onClick="badgeClick(this.value)" class="btn btn-dark" value="ETL">ETL's <span class="badge badge-light">8</span></button>
    ...
    <div class="row text-center">
        <div class="col-sm-12"> 
            ...
            <button type="button" onClick="badgeClick(this.value)" class="btn btn-dark" value="Business Intelligence">Business Intelligence <span class="badge badge-light">9</span></button>                    
            ...
            <button type="button" onClick="badgeClick(this.value)" class="btn btn-dark" value="Tableau">Tableau <span class="badge badge-light">5</span></button>                
        </div>     
    </div>
    <br> 
    <div class="row">
